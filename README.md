...
| 2021년 8월             | 교내 소프트웨어 경진대회                                     | - 성신여자 대학교 새내기들에게 실내, 대학가, 학교주변의 문화, 음식, 의류 정보를 제공해주는 애플리케이션 개발  <br />- youtube data api 를 사용하여 자취를 하는 학생들에게 테마별로 레시피 영상을 제공하는 기능 구현<br />- open weather map api를 사용하여 날씨에 맡는 옷차림을 제공하는 기능 구현<br />- 네이버 웹툰 크롤링을 통해 사용자 취향에 알맞은 웹툰 정보를 제공하는 기능 구현<br />- 안드로이드 담당 <br />- [[Review]](https://blog.naver.com/dev_aerim/222494243889) | 장려상                                                    |
